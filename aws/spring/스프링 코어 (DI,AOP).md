...
|        방법        |설명                         |
|----------------|-------------------------------|
|자바 기반 설정 방식 | 자자바 클래스에 @Configuration 어노테이션을 메소드에 @Bean 어노테이션을 사용해 빈을 정의하는 방법. 특히 스프링 부트에서 많이 활용된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1MTMxODM2MSwxMTQwODU2ODA5LDE1OD
k0ODA3NzAsMTk1ODAxMDkyMSwxODE5NzgzNjk4LDE0NDkyNjM0
ODFdfQ==
-->