...
### Listeners
Listener 는 Sampler 들의 결과를 로그 파일에 간단한 text, tree, table, graph 형태로 보여준다. JMeter 로 수집한 데이터를 시각적으로 제공한다. 데이터는 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwMzUzMTE2MSwtMTY3OTI2Mzk5MiwxNT
