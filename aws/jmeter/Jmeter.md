...
### Listeners
Listener 는 Sampler 들의 결과를 로그 파일에 간단한 text, tree, table, graph 형태로 보여준다. JMeter 로 수집한 test case ㅇ데이터를 시각적으로 제공한다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTE5NDg3MiwtMTY3OTI2Mzk5MiwxNT
