...
### 범위
자바스크립트에서는 두 가지 scope 가 있다. **함수의 scope** 와 **전역 scope** 다. 전여


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2NTQwNTIyLC0xOTMxOTEzNDIsMTM1Mj
M2Mjg1NSwxOTAyMDczMjkxLDY0MjYwMTE4NCwtMTQxNzA2OTU3
