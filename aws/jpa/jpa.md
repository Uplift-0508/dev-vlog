...
일반적으로 xml 파일들은 특정 컴포넌트를 설정하거나 두 개의 다른 컴포넌트 스펙을 매핑하기 위해 사용한다. 지금은 프래임워크에서 별도로 xml 파일을 유지해야한다. 이것은 매핑 xml 파일을 작성하는 동안 mapping.xml 파일 안에 entit
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDc2ODY4MDMsLTUwODAyMDc0OSwxNz
