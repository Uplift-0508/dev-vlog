...
관계형 객체 관리를 위해 코드를 작성하는 부담을 줄이기 위해서, 프로그래머들은 'JPA Provider' 프레임워크를 따랐다. 이는 데이터베이스 인스턴스와 쉽게 상호작용하도록 도와주었다. 이런 필요한 프레임워크들은 JPA 에 인수되었다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxNDE3MTMyNCwxODAxMzM1MDY1LDcyOD
