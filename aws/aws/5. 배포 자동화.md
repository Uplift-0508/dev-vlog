...
## CodeDeploy
CodeDeploy 는 AWS 에서 제공하는 **배포 자동화 서비스**입니다. 다른 서드파티 배포 자동화 도구보다 더 좋은 점은, AWS 에서 제공하는 서비스이기 때문에 AWS 내 다양한 서비스와 손쉽게 연동해서 사용할 수 있습니다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1Mzg5NjMxMzAsMTU1Nzc5OTE2MCwtOT
Y2NTA4NDU1LC05NjY1MDg0NTUsMjI4NTkxMDIyXX0=
-->