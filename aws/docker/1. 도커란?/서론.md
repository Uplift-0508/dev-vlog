...
일반적으로 도커라고 하면 도커 엔진이라는 의미로 많이 쓰입니다. **도커 엔진**은 컨테이너를 생성하고 관리하는 주체로서 이 자체로 컨테이너를 재어할 수 있고 다양하느 기능을 제공하는 도커의 주 프로젝트입니다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzc1Mzk0ODI4LC0xMTU5MDY5OTEwXX0=
-->