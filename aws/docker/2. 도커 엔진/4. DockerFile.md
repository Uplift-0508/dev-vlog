...
Dockerfile 이 위치한 곳에는 이미지 빌드에 필요한 파일만 있는 것이 바람직하고, 이미지 빌드는 빌드 컨텍스트에서 해야한다. 컨텍스트는 단순 파일뿐 아니라 하위 디렉터리도 전부 포함하기 때문에, 빌드에 불필요한 파일이 포함된다면 빌드 속도가 느려지고 호스트의 메모리를 지나치게 점유할 수도 있다.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5MjU1MjcxMCwzNTc5MzM2MjMsMTQ2MT
I1ODYwMSwtMTkyOTY3MzczNiwxOTMzNjE4MTMsLTE0MTU3NjIw
MjUsNzQzOTc5OTQzLC0xODA2NTIzNTQ2LDU2NzgzODgxLC00Nj
Q1NDQwMTAsMTk5MzU0MTM2OCw2MjE2OTU1MDIsLTM5NDMzMjUs
MTczMjczOTk5XX0=
-->